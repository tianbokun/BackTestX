...
from ui.holdings_analyzer import render_holdings_analyzer
...
mode = st.radio(
    "_mode",
    ["🏠 首页", "📊 定投回测", "🎯 网格搜索", "🧮 智能定投", "🤖 强化学习", "🧠 分层RL", "📊 持仓分析", "📊 情绪数据", "📋 训练任务", "📋 代码管理"],
    horizontal=True,
...
needs_sidebar_symbol = (mode.startswith("📊") and "情绪" not in mode and "持仓" not in mode) or mode.startswith("🎯")
